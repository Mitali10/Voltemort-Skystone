...
@Autonomous(name="Auto:BlueLeftLinear3",group = "Auto")
@Disabled
public class RelicLeftBlueAutonomousLinear3 extends LinearOpMode {

    enum Task{INIT_SERVO, INIT_PICTOGRAPH, DROP_ARM, MOVE_JEWEL, RAISE_ARM, GRAB_GLYPH, REVERSE, TURN_LEFT, MOVE_FORWARD, TURN_LEFT_AGAIN, SEEK_BOX, STRADDLE, DROP_GLYPH, HALT, TEST, ADJUST_GLYPH, RUN_LED };
	...
	private String PICTOGRAPH_BOX_LOCATION = "C" ; // Values: L, C, R. C is the default
			   ...
			   break;
                ...
                case TURN_LEFT:
				   ...
				   if (PICTOGRAPH_BOX_LOCATION.equalsIgnoreCase("L")) {
                    ...
                    while ((MRgyro.getIntegratedZValue() <= turnAngle) && runtime.seconds()<=10) {
