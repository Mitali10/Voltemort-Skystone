...
@Autonomous(name="RoverTest:strafeRighting",group = "RoverTest")
@Disabled
public class strafeRighting extends LinearOpMode{

    enum Task{STRAFE_RIGHT, HALT };
