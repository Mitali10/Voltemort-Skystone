...
@Autonomous(name = "RoverAuto:RightBlueAutonomous", group = "RoverTest")
@Disabled
public class RoverRightBlueAutonomous extends RoverAutonomousBase {
        ...
        while (opModeIsActive()) {
            ...
            switch (nextTask) {
                ...
                case SCAN_LEFT:
                    ...
                    boolean result = encoderStrafeLeftSearching(0.15, 38, 10, .45);
                    if (result) {
