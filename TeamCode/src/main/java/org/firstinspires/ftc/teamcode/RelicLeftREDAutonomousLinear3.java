...
@Autonomous(name="Auto:REDLeftLinear3",group = "Auto")
@Disabled
public class RelicLeftREDAutonomousLinear3 extends LinearOpMode {

    enum Task{INIT_SERVO, INIT_PICTOGRAPH,INIT_BACKUP, DROP_ARM, MOVE_JEWEL, RAISE_ARM, GRAB_GLYPH, REVERSE, TURN_RIGHT, MOVE_FORWARD,MOVE_FORWARD_AGAIN, TURN_LEFT_AGAIN, SEEK_BOX, STRADDLE, DROP_GLYPH, HALT, TEST, ADJUST_GLYPH,RUN_LED};

    Task nextTask;


    private DcMotor wheelRight,wheelLeft,towerMotor,led;
            ...
            switch (nextTask) {
			   ...
			   break;
                ...
                case MOVE_FORWARD:
                    ...
                    nextTask= Task.TURN_RIGHT;

                    break;

                case TURN_RIGHT:
				
					int turnAngle = -50; //from 50
				   
				   if (PICTOGRAPH_BOX_LOCATION.equalsIgnoreCase("L")) {         //least
				       turnAngle = -39;
				   } else if (PICTOGRAPH_BOX_LOCATION.equalsIgnoreCase("R")) {  //most
				       turnAngle = -71;
				   } 
