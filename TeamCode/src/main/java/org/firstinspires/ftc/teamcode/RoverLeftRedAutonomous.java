...
@Autonomous(name = "RoverAuto:LeftRedAutonomous", group = "RoverTest")
@Disabled
public class RoverLeftRedAutonomous extends RoverAutonomousBase {
        ...
        while (opModeIsActive()) {
            ...
            switch (nextTask) {
                ...
                case SCAN_LEFT:
                    ...
                    boolean result = encoderStrafeLeftSearching(0.15, 38, 10, 0.60);
                    if (result) {
                ...
                case CUBE_RIGHT:
                    ...
                    encoderStrafeLeft(0.8, 44, 10); //increased from 42 bc not close enough to wallc
                    nextTask = Task.RUN_STRAIGHT_2;
                    break;
