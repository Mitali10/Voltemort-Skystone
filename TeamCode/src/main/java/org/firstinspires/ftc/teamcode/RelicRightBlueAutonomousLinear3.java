...
@Autonomous(name="Auto:BlueRightLinear3",group = "Auto")
@Disabled
public class RelicRightBlueAutonomousLinear3 extends LinearOpMode {

    enum Task{INIT_SERVO, INIT_PICTOGRAPH,INIT_BACKUP, DROP_ARM, MOVE_JEWEL, RAISE_ARM, GRAB_GLYPH, REVERSE, TURN_RIGHT, MOVE_FORWARD, TURN_LEFT_AGAIN, SEEK_BOX, STRADDLE, DROP_GLYPH, HALT, TEST, ADJUST_GLYPH,RUN_LED };
